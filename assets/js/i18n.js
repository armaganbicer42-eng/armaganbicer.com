(function () {
  var translations = {
    en: {
      ...
      item1Name: 'Wood, Glass, Metal Organizer Board',
      item2Name: 'This Is Fine (F*ck) Pillow',
      item3Name: 'Mini Tote Bag',
      shopCta: 'visit the shop &rarr;',
    ...
    tr: {
      ...
      item1Name: 'Ahşap, Cam, Metal Organizer Pano',
      item2Name: 'This Is Fine (F*ck) Pillow',
      item3Name: 'Mini Tote Çanta',
      shopCta: 'mağazayı ziyaret et &rarr;',
